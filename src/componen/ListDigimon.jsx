...
function ListDigimon() {
  ...
  return (
    <section className="list-digimon">
      <Card img="https://digimon.shadowsmith.com/img/agumon.jpg" name="Agumon" />
      <Card img="https://digimon.shadowsmith.com/img/patamon.jpg" name="Patamon" />
      <Card img="https://digimon.shadowsmith.com/img/veemon.jpg" name="Veemon" />

      {digimons.map((item, index) => (
        <Card key={index} img={item.gambar} name={item.name} />
      ))}
    </section>
  );
}
